...
public class FenetrePrincipale extends JFrame implements ActionListener
{
		...
		/**
		 * Arbre de la définition de processus
		 */
		private VueDPArbre vueDPArbre;


		/**
		 * Arbre du référentiel
		 */
		private VueReferentielArbre vueRefArbre ;
		
		/**
		 * Composant permettant de séparer la fenêtre en 2 parties verticales
		 */
		private JSplitPane frame_split;
		private PanneauVerification panneauVerif ;
		
		
		// Eléments graphiques à afficher
		...
		/**
		 * Onglets pour afficher l'arbre et le référentiel
		 */
	...
	{	
		...
		// créaton d'un arbre vide
		this.vueDPArbre = new VueDPArbre();
		// Création d'un arbre représentant le référentiel
		this.vueRefArbre = new VueReferentielArbre () ;
		// taille de la fenêtre en fonction du système d'accueil
		...
		// placer les éléments au bon endroit dans la fenêtre 
		this.positionnerElements();
		// permettre de récupérer les évènements utilisateur
	...
	/**
	 * Méthode permettant d'ajouter des raccourcis à certains items du menu
	 */
	...
	{
		// créer un barre d'outil vide
		this.barre_outil = new JToolBar();
		// créer et rajouter les boutons à la barre
	...
	/**
	 * Méthode permettant de positionner correctement tous les éléments créés
	 */
	private void positionnerElements()
	{
		// créer le panneau contenant le diagramme
		...
		// positionner les onglets et le panneau générique
	...
	/**
	 * Méthode permettant d'écouter les évènements sur les menus, boutons etc... pour pouvoir
	...
	/**
	 * Une fois la vue créée (l'arbre) on l'affiche sur la partie gauche de la fenetre principale
	 * @param vue, arbre à afficher sur la partie gauche
	 */
	...
	/**
	 * Récupérer la vue arbre
	 * @return arbre de la définition de processus courante
	 */
	...
	/**
	 * Affiche sur la partie de droite le panneau correspondant à l'action courante
	 * par exemple affiche le panneau correspondant à l'édition du processus
	 * @param p, panneau à afficher sur la droite de la fenetre
	 */
	public void setPanneauGenerique (JPanel p)
	{
		// garder un lien vers le panneau à afficher
		this.panneauGenerique = p;
		this.panneauVerif = new PanneauVerification(this.panneauGenerique);
		// met en place le panneau
		this.frame_split.setRightComponent(this.panneauVerif);
		// remet la division de la fenêtre comme au départ
		this.frame_split.setDividerLocation(220);
	}
	...
	/**
	 *  Met à jour les labels de la fenetre principale lors d'un changement de langue
	 */
	...
	public void majEtat()
	{
	 ...
	 //	gestion des évènements (boutons et menus)
	 public void actionPerformed (ActionEvent e)
	 {
			 ...
			 // on peut lancer une même action à partir de sources différentes
			 ...
			 {
					// afficher la liste des DP disponibles dans le référentiel
