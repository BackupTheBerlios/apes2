...
//		 fichier contenu
	...
	private class ManagerButton implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				Color couleur_choisie = JColorChooser.showDialog(PanneauGenerationOption.this,Application.getApplication().getConfigPropriete("choix_couleur"), new Color(Integer.parseInt(Application.getApplication().getConfigPropriete("couleur_arbre"))));
