...
public class TestFlowDiagram extends TestCase
{
	...
	public void testCreateLinkProcessRoleActivityTwice()
	{
		ProcessRole pr1 = createProcessRole();
		ProcessRole pr2 = createProcessRole();
		Activity a = createActivity();
		FlowDiagram cd1 = new FlowDiagram();
		FlowDiagram cd2 = new FlowDiagram();
		
		assertFalse(cd1.createLinkProcessRoleActivity(pr1,a));
		assertFalse(cd1.createLinkProcessRoleActivity(pr2,a));
		assertFalse(cd2.createLinkProcessRoleActivity(pr1,a));
		assertFalse(cd2.createLinkProcessRoleActivity(pr2,a));
		
		cd1.addProcessRole(pr1);
		cd2.addProcessRole(pr2);
		
		cd1.addActivity(a);
		cd2.addActivity(a);
		
		assertTrue(cd1.createLinkProcessRoleActivity(pr1,a));
		assertFalse(cd2.createLinkProcessRoleActivity(pr2,a));
	}
	...
	/*public void testCreateLinkProcessRoleWorkProduct()
	{
		...
		assertFalse(cd.createLinkProcessRoleWorkProduct(pr,wp));
		
		cd.addProcessRole(pr);
		assertFalse(cd.createLinkProcessRoleWorkProduct(pr,wp));
		
		cd.addWorkProduct(wp);
		assertFalse(cd.createLinkProcessRoleWorkProduct(pr2,wp));
		assertTrue(cd.createLinkProcessRoleWorkProduct(pr,wp));
		
		cd.addWorkProduct(wp2);
		assertTrue(cd.createLinkProcessRoleWorkProduct(pr,wp2));
		
		assertFalse(cd.createLinkProcessRoleWorkProduct(pr,wp));
	}*/

	/*public void testCreateLinkProcessRoleWorkProductTwice()
	{
		ProcessRole pr1 = createProcessRole();
		ProcessRole pr2 = createProcessRole();
		WorkProduct wp = createWorkProduct();
		...
		assertFalse(cd1.createLinkProcessRoleWorkProduct(pr1,wp));
		assertFalse(cd1.createLinkProcessRoleWorkProduct(pr2,wp));
		assertFalse(cd2.createLinkProcessRoleWorkProduct(pr1,wp));
		assertFalse(cd2.createLinkProcessRoleWorkProduct(pr2,wp));
		
		cd1.addProcessRole(pr1);
		cd2.addProcessRole(pr2);
		
		cd1.addWorkProduct(wp);
		cd2.addWorkProduct(wp);
		
		assertTrue(cd1.createLinkProcessRoleWorkProduct(pr1,wp));
		assertFalse(cd2.createLinkProcessRoleWorkProduct(pr2,wp));
	}*/
