...
public class ComponentView extends ApesVertexView
{
	...
	public Point getPerimeterPoint(Point source, Point p) 
	{
		...
		x[1]= r.x +100;//+ r.width/2 + 15;
		x[2]= r.x +100;//+ r.width/2 + 20;
		x[3]= r.x ;//+ r.width/2 + 20;
		x[4]= r.x ;//+ r.width/2 - 20;
		y[0]= r.y;
		y[1]= r.y;
		y[2]= r.y +100;//+ 5;
		y[3]= r.y +100;//+ r.height - 16;
		y[4]= r.y + r.height - 16;
	...
	static class ComponentViewRenderer extends VertexRenderer
	{
		public void paint(Graphics g)
		{
			...
			y1[1]= b + 1+2;
			y1[2]= b + 1 + 10+2;
			y1[3]= d.height + b - 16 -30;
			y1[4]= d.height + b - 16 -30;
			...
			x2[8]= (d.width)/3+10-2;
			x2[9]= (d.width)/3+10-2;
			x2[10]= (d.width)/3-20-2;
			x2[11]= (d.width)/3-20-2;
			x2[12]= (d.width)/3-25-2;
			x2[13]= (d.width)/3-25-2;
			x2[14]= (d.width)/3-10-2;
			x2[15]= (d.width)/3-10-2;
			x2[16]= (d.width)/3-25-2;
			x2[17]= (d.width)/3-25-2;
			x2[18]= (d.width)/3-10-2;
			x2[19]= (d.width)/3-10-2;
			...
			if (super.isOpaque()) 
			{
				...
				g.drawLine(d.width/2 + 35,b+1+2,d.width/2 + 35,b+1+10+2);
				g.drawLine(d.width/2 + 35,b+1+2+10,d.width/2 + 45,b+1+10+2);
				
				c = new Color(0,0,255);
				g.setColor(c);
				g.fillOval(d.width/4-9, 5, 20,20);
				g.fillPolygon(x2,y2,20);
				
				g.setColor(bordercolor);
				g2.setStroke(new BasicStroke(b));
				g.drawOval(d.width/4-9,5,20,20);
