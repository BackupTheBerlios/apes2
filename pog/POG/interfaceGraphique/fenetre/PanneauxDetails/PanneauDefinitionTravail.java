...
public class PanneauDefinitionTravail extends PanneauDetail {

  JLabel jLabel5 = new JLabel();
  JList list_activite = new JList();
  JLabel jLabel7 = new JLabel();
  JTable list_guides = new JTable();
  JLabel titre_modele = new JLabel();
  JScrollPane jScrollPane1 = new JScrollPane();
  JLabel jLabel9 = new JLabel();
  JScrollPane scrollpaneGuides;


  public PanneauDefinitionTravail(ControleurPanneaux control) {
    super(control);
    try {
      jbInit();
    }
  ...
  public void loadElement(ElementPresentation elem) {
    ...
    setLabelNomPres(FenetrePrincipale.INSTANCE.getLnkLangues().valeurDe("nomDefTrav"));
